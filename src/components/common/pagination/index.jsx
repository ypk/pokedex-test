...
const Pagination = ({ nextPageUrl, prevPageUrl }) => {
    return (
        <div className="bg-gray-100 pt-4 md:pt-8 pb-6 md:pb-12 px-10 flex flex-row justify-center">
            {
                prevPageUrl &&
                <button data-testid="prevPage" onClick={prevPageUrl} className="block rounded-xl shadow-lg font-bold py-4 pl-3 pr-4 mr-4 flex items-center bg-yellow-300 hover:bg-yellow-400 focus:bg-yellow-400">
            ...
            {
                nextPageUrl &&
                <button data-testid="nextPage" role="button" onClick={nextPageUrl} className="block rounded-xl shadow-lg font-bold py-4 pr-3 pl-4 ml-4 flex items-center  bg-yellow-300 hover:bg-yellow-400 focus:bg-yellow-400">
